...
router.patch("/mess/bazar/items/:id/status", requireAuth, updateBazarItemStatus);
router.delete("/mess/bazar/items/:id", requireAuth, deleteBazarItem);
router.delete("/mess/bazar/items", requireAuth, deleteBazarItems);
router.post("/mess/bazar/items/add-to-expense", requireAuth, addBazarItemsToExpense);
